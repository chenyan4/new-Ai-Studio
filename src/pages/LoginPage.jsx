...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    // 这里使用 ref 来跟踪 hovering 状态，以便在 requestAnimationFrame 中读取最新值
  ...
  // 更新 Hover ref (在不重启canvas动画的前提下，通知canvas鼠标状态)
  ...
  const handleMouseMove = (e) => {
    ...
    // 如果想要将状态传入canvas闭包，这里有些 trick。为简单起见，我们在上面用 hoverRef。
    // 但是这里需要更新组件 state，来控制表单显示
  ...
  return (
    <div className="login-page" onMouseMove={handleMouseMove}>
      ...
      <div className={`login-form ${isHovering ? "visible" : ""}`}>
