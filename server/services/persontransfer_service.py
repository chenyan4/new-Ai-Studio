...
MODEL_ENDPOINT_MAP = {
    "qwen_edit_2511": "/qwen_edit_2509_pose_cb",
}
...
async def generate_persontransfer(person_image, bg_image, model: str):
    ...
    endpoint = MODEL_ENDPOINT_MAP.get(model, "/qwen_edit_2509_pose_cb")
    ...
    filename = f"persontransfer_{uuid.uuid4().hex[:8]}_{int(time.time())}.png"
    ...
    return {"images": [image_url], "type": "persontransfer"}
